...
%\resheading{Skills}
%\begin{itemize}
%\item \textbf{Computer skills:} Python, Unix, C++, R, SQL
%\item \textbf{Classes:} Algorithms, machine learning, databases, social network analysis, graph algorithms, algebraic graph algorithms, systems, complexity theory, computability theory, real analysis, abstract algebra, stochastic processes, combinatorics, dynamical systems, quantum mechanics
%\end{itemize}
